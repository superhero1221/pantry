...
export const extra: Record<string, string> = {
    ...
    photoCredit: 'Zdjęcie: {who} · {licence}',
    photoCreditOpen: 'otwiera oryginał w Wikimedia Commons',
    photoLicenceOpen: 'otwiera warunki licencji',
    photoCreditsTitle: 'Zdjęcia potraw ({n})',
    photoCreditsIntro:
      'Nazwa autora otwiera oryginał w Wikimedia Commons, a licencja jej warunki. Potrawy bez zdjęcia mają rysunki wykonane dla Pantry.',
    photoPublicDomain: 'Domena publiczna',
    ...
    timeLeft: 'Zostało {m} min minutników, po kolei',
    basketPer: 'Na porcję',
