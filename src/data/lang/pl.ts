...
export const pack: Record<string, unknown> = {
  ...
  "h": {"daysWord":"dni","forServings":"one:na {n} porcję|few:na {n} porcje|other:na {n} porcji","otherChip":"Inna","findMe":"Znajdź mi {q}","inKitchen":"{n} rzeczy już masz w kuchni","passportNudge":"84 kraje, z których nigdy nie gotowałeś. Najtańszy, którego ci brakuje, to Etiopia — misir wot wychodzi {a} za porcję.","liveShops":"one:{n} sklep w zasięgu spaceru, prosto z OpenStreetMap|few:{n} sklepy w zasięgu spaceru, prosto z OpenStreetMap|other:{n} sklepów w zasięgu spaceru, prosto z OpenStreetMap","week":["P","W","Ś","C","P","S","N"]},
  "v": {
...
export const extra: Record<string, string> = {
    ...
    planCook: 'Ugotuj to',
    planDay: 'Dzień',
    streakShort: "one:{n} dzień|other:{n} dni",
    streakRunning: "one:{n} dzień z rzędu|other:{n} dni z rzędu",
    daysBadge: "one:DZIEŃ|other:DNI",
    dishesCount: "one:{n} danie|few:{n} dania|other:{n} dań",
    minutesShort: "{n} min",
    mealsCount: "one:{n} posiłek|few:{n} posiłki|other:{n} posiłków",
    cookedNTimes: "one:gotowane {n} raz|other:gotowane {n} razy",
    toBuyForN: "one:do kupienia, na {n} porcję|few:do kupienia, na {n} porcje|other:do kupienia, na {n} porcji",
    planNeedsAccount:
    ...
    passportNudgeReal:
      "one:{n} kraj z tej książki, z którego nigdy nie gotowałeś: {c} — {d} wychodzi {a} za porcję.|few:{n} kraje z tej książki, z których nigdy nie gotowałeś. Najtańszy, którego ci brakuje, to {c} — {d} wychodzi {a} za porcję.|other:{n} krajów z tej książki, z których nigdy nie gotowałeś. Najtańszy, którego ci brakuje, to {c} — {d} wychodzi {a} za porcję.",
    ...
    pantryLineSample: "one:{n} rzecz, która zwykle jest w kuchni|other:{n} rzeczy, które zwykle są w kuchni",
    ...
    dataImported: "one:Wczytane. Wróciło z tym {n} gotowanie.|few:Wczytane. Wróciły z tym {n} gotowania.|other:Wczytane. Wróciło z tym {n} gotowań.",
    ...
    /* ── The small print ── */
    someMeasured: "one:{n} z {of} pozycji tutaj to prawdziwa cena, którą ktoś zapłacił i zgłosił — kropka obok pokazuje którą. Reszta jest modelowana: dobry szacunek, nie paragon.|other:{n} z {of} pozycji tutaj to prawdziwe ceny, które ktoś zapłacił i zgłosił — kropki obok pokazują które. Reszta jest modelowana: dobry szacunek, nie paragon.",
    noneOfThat: "Nie mam {q} w książce — jeszcze nie. Najbliżej jest {d}.",
    lastOfThat: "one:To ostatnie, co mam z {q}. Jest tylko {n} i już to widziałeś.|few:To ostatnie, co mam z {q}. Są {n} i widziałeś już wszystkie.|other:To ostatnie, co mam z {q}. Jest ich {n} i widziałeś już wszystkie.",
    goWider: "Pokaż mi cokolwiek",
    whyTitle: "Dlaczego to",
    whyBudget: "Mieści się w {b}, które ustawiłeś",
    whyTime: "one:{t} minuta, poniżej {m}, o które prosiłeś|few:{t} minuty, poniżej {m}, o które prosiłeś|other:{t} minut, poniżej {m}, o które prosiłeś",
    ...
    slideGo: "Ruszamy",
    priceHome: "Od tej chwili wszystkie ceny są podane w walucie: {cur} — w sklepach, które naprawdę są w pobliżu. Coś się nie zgadza?",
    curGBP: "funt szterling",
    curUSD: "dolar amerykański",
    curINR: "rupia indyjska",
    curNGN: "naira",
    curPKR: "rupia pakistańska",
    curEUR: "euro",
    curAED: "dirham",
    curTRY: "lira turecka",
    ...
    jevReadAs: "Zrozumiane jako",
    jevUndo: "Cofnij",
    jevQuick: "Szybko",
    jevCheap: "Tanio",
    jevComforting: "Na pocieszenie",
    jevLight: "Lekko",
    jevHighProtein: "Dużo białka",
    jevSpicy: "Ostro",
    jevMeatFree: "Bez mięsa",
    jevCheckTitle: "Sprawdź produkt",
    jevCheckBody: "Masz coś, czego nie ma na tych listach? Wpisz to, a sprawdzę to z twoimi dietami.",
    jevCheckPlaceholder: "np. sos Worcestershire",
    jevCheckBtn: "Sprawdź",
    jevChecking: "Sprawdzam…",
    jevCautionApp: "{d}: {i} łamie to ustawienie.",
    jevCautionJev: "{d}: {i} często zawiera coś, co to ustawienie wyklucza. Sprawdź etykietę.",
    jevNoClash: "Nie widzę konfliktu z twoimi dietami. Etykiety bywają różne, więc sprawdź opakowanie, jeśli to ważne.",
    jevNoCheck: "Nie udało się teraz zapytać o drugą opinię. Rozstrzyga etykieta.",
    jevPriceHigh: "To około {r}× więcej niż zwykła cena tutaj ({m} za {g} g).",
    jevPriceLow: "To około {r}× mniej niż zwykła cena tutaj ({m} za {g} g).",
    jevPriceOdd: "To wygląda nietypowo dla tego produktu tutaj (zwykle około {m} za {g} g).",
    jevPriceMean: "Czy chodziło ci o {p}?",
    jevHintCurrency: "Czy wpisałeś to w innej walucie?",
    jevHintPerKg: "Czy to była cena za kilogram, a nie za opakowanie?",
    jevHintItem: "Czy to był inny produkt — premium, gotowy albo duże opakowanie?",
    jevPriceUse: "Użyj {p}",
    jevPriceKeep: "Jest dobrze — wyślij",
    jevPriceEdit: "Poprawię",
};
