...
export const pack: Record<string, unknown> = {
  ...
  "h": {"daysWord":"jours","forServings":"one:pour {n} portion|other:pour {n} portions","otherChip":"Autre","findMe":"Trouvez-moi {q}","inKitchen":"{n} choses déjà dans votre cuisine","passportNudge":"84 pays dont vous n’avez jamais rien cuisiné. Le moins cher qui vous manque est l’Éthiopie : le misir wot revient à {a} la portion.","liveShops":"one:{n} magasin à pied, directement d’OpenStreetMap|other:{n} magasins à pied, directement d’OpenStreetMap","week":["L","M","M","J","V","S","D"]},
  "v": {
...
export const extra: Record<string, string> = {
    ...
    planDay: 'Jour',
    streakShort: "one:{n} jour|other:{n} jours",
    streakRunning: "one:{n} jour d’affilée|other:{n} jours d’affilée",
    daysBadge: "one:JOUR|other:JOURS",
    dishesCount: "one:{n} plat|other:{n} plats",
    minutesShort: "{n} min",
    mealsCount: "{n} repas",
    cookedNTimes: "cuisiné {n} fois",
    toBuyForN: "one:à acheter, pour {n} portion|other:à acheter, pour {n} portions",
    planNeedsAccount:
    ...
    pantryLineSample: "one:{n} chose qu'une cuisine a d'habitude|other:{n} choses qu'une cuisine a d'habitude",
    ...
    photoCreditOpen: 'ouvre l’original sur Wikimedia Commons',
    photoLicenceOpen: 'ouvre les conditions de la licence',
    photoCreditsTitle: 'Photos des plats ({n})',
    photoCreditsIntro:
      'Le nom de l’auteur ouvre l’original sur Wikimedia Commons ; la licence, ses conditions. Les plats sans photo ont des dessins faits pour Pantry.',
    photoPublicDomain: 'Domaine public',
    ...
    dataImported: "one:Chargé. {n} plat est revenu avec.|other:Chargé. {n} plats sont revenus avec.",
    ...
    /* ── The small print ── */
    someMeasured: "one:{n} des {of} lignes ici est un vrai prix payé et signalé par quelqu’un — le point à côté dit laquelle. Le reste est modélisé : une bonne estimation, pas un ticket de caisse.|other:{n} des {of} lignes ici sont de vrais prix payés et signalés par quelqu’un — les points à côté disent lesquels. Le reste est modélisé : une bonne estimation, pas un ticket de caisse.",
    noneOfThat: "Pas de {q} dans le livre — pas encore. Le plus proche que j’aie est {d}.",
    lastOfThat: "one:C’est le dernier {q} que j’ai. Il y en a {n}, et vous l’avez vu.|other:C’est le dernier {q} que j’ai. Il y en a {n}, et vous les avez tous vus.",
    goWider: "Montrez-moi n’importe quoi",
    whyTitle: "Pourquoi celui-ci",
    whyBudget: "Dans les {b} que vous avez fixés",
    whyTime: "one:{t} minute, sous les {m} demandées|other:{t} minutes, sous les {m} demandées",
