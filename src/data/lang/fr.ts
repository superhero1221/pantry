...
export const extra: Record<string, string> = {
    ...
    jevReadAs: "Compris comme",
    jevUndo: "Annuler",
    jevQuick: "Rapide",
    jevCheap: "Pas cher",
    jevComforting: "Réconfortant",
    jevLight: "Léger",
    jevHighProtein: "Riche en protéines",
    jevSpicy: "Épicé",
    jevMeatFree: "Sans viande",
    jevCheckTitle: "Vérifier un produit",
    jevCheckBody: "Vous avez quelque chose qui n’est pas dans ces listes ? Tapez-le et je le vérifie selon vos régimes.",
    jevCheckPlaceholder: "ex. sauce Worcestershire",
    jevCheckBtn: "Vérifier",
    jevChecking: "Vérification…",
    jevCautionApp: "{d} : {i} ne respecte pas ce réglage.",
    jevCautionJev: "{d} : {i} contient souvent quelque chose que ce réglage exclut. Vérifiez l’étiquette.",
    jevNoClash: "Aucun conflit repéré avec vos régimes. Les étiquettes varient : vérifiez le paquet si c’est important.",
    jevNoCheck: "Impossible d’avoir un deuxième avis pour l’instant. L’étiquette fait foi.",
    jevPriceHigh: "C’est environ {r}× le prix habituel ici ({m} pour {g} g).",
    jevPriceLow: "C’est environ {r}× moins que le prix habituel ici ({m} pour {g} g).",
    jevPriceOdd: "Cela paraît inhabituel pour ce produit ici (d’habitude environ {m} pour {g} g).",
    jevPriceMean: "Vouliez-vous dire {p} ?",
    jevHintCurrency: "L’avez-vous tapé dans une autre devise ?",
    jevHintPerKg: "Était-ce le prix au kilo plutôt que celui du paquet ?",
    jevHintItem: "Était-ce un autre produit — haut de gamme, préparé ou en gros ?",
    jevPriceUse: "Utiliser {p}",
    jevPriceKeep: "C’est juste — envoyer",
    jevPriceEdit: "Je corrige",
};
