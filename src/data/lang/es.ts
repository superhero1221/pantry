...
export const pack: Record<string, unknown> = {
  ...
  "s": {"shopSub":"tiendas a pie de","sameBasket":"La misma cesta, {n} precios.","openTill":"abierto hasta las","hoursUnknown":"horario desconocido"},
...
export const extra: Record<string, string> = {
    ...
    photoCredit: 'Foto: {who} · {licence}',
    photoCreditOpen: 'abre el original en Wikimedia Commons',
    photoLicenceOpen: 'abre las condiciones de la licencia',
    photoCreditsTitle: 'Fotos de los platos ({n})',
    photoCreditsIntro:
      'El nombre del autor abre el original en Wikimedia Commons; la licencia, sus condiciones. Los platos sin foto tienen dibujos hechos para Pantry.',
    ...
    timeLeft: 'Quedan {m} min de temporizadores, de uno en uno',
    ...
    slideH1: "La cena, decidida",
    slideS1: "Dime qué te apetece y cuánto llevas en el bolsillo. Yo decido.",
    slideH2: "Una cosa cada vez",
    slideS2: "Nada de muros de opciones. Un plato, un motivo por el que está ahí, y una forma de cambiar de idea.",
    slideH3: "Con precios de donde estás",
    slideS3: "Cada plato lleva un rango de precios de las tiendas cercanas, en tu moneda: no una cifra de Londres con otro símbolo.",
    slideH4: "Gratis. Todo",
    slideS4: "Todas las recetas, todos los precios, seis idiomas. Sin cuenta, sin tarjeta, sin nada guardado para después.",
