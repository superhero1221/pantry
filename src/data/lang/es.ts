...
export const pack: Record<string, unknown> = {
  ...
  "h": {"daysWord":"días","forServings":"one:para {n} ración|other:para {n} raciones","otherChip":"Otro","findMe":"Búscame {q}","inKitchen":"{n} cosas que ya tienes en la cocina","passportNudge":"84 países de los que nunca has cocinado. El más barato que te falta es Etiopía: el misir wot sale a {a} la ración.","liveShops":"one:{n} tienda a pie, directa de OpenStreetMap|other:{n} tiendas a pie, directas de OpenStreetMap","week":["L","M","X","J","V","S","D"]},
  "v": {
...
export const extra: Record<string, string> = {
    ...
    planCook: 'Cocinarlo',
    planDay: 'Día',
    streakShort: "one:{n} día|other:{n} días",
    streakRunning: "one:{n} día seguido|other:{n} días seguidos",
    daysBadge: "one:DÍA|other:DÍAS",
    dishesCount: "one:{n} plato|other:{n} platos",
    minutesShort: "{n} min",
    mealsCount: "one:{n} comida|other:{n} comidas",
    cookedNTimes: "one:cocinado {n} vez|other:cocinado {n} veces",
    toBuyForN: "one:de compra, para {n} ración|other:de compra, para {n} raciones",
    planNeedsAccount:
    ...
    passportNudgeReal:
      "one:{n} país de este recetario del que nunca has cocinado: {c}. {d} sale a {a} la ración.|other:{n} países de este recetario de los que nunca has cocinado. El más barato que te falta es {c}: {d} sale a {a} la ración.",
    ...
    pantryLineSample: "one:{n} cosa que suele haber en una cocina|other:{n} cosas que suele haber en una cocina",
    ...
    dataImported: "one:Cargado. Ha vuelto {n} comida con él.|other:Cargado. Han vuelto {n} comidas con él.",
    ...
    /* ── The small print ── */
    someMeasured: "one:{n} de las {of} líneas de aquí es un precio real que alguien pagó y comunicó — el punto al lado indica cuál. El resto están modelados: una buena estimación, no un ticket.|other:{n} de las {of} líneas de aquí son precios reales que alguien pagó y comunicó — los puntos al lado indican cuáles. El resto están modelados: una buena estimación, no un ticket.",
    noneOfThat: "No hay {q} en el libro — todavía. Lo más cercano que tengo es {d}.",
    lastOfThat: "one:Eso es todo lo que tengo de {q}. Solo hay {n}, y ya lo has visto.|other:Eso es todo lo que tengo de {q}. Son {n}, y ya los has visto todos.",
    goWider: "Enséñame lo que sea",
    whyTitle: "Por qué esta",
    whyBudget: "Dentro de los {b} que fijaste",
    whyTime: "one:{t} minuto, por debajo de los {m} que pediste|other:{t} minutos, por debajo de los {m} que pediste",
    ...
    jevReadAs: "Entendido como",
    jevUndo: "Deshacer",
    jevQuick: "Rápido",
    jevCheap: "Barato",
    jevComforting: "Reconfortante",
    jevLight: "Ligero",
    jevHighProtein: "Rico en proteína",
    jevSpicy: "Picante",
    jevMeatFree: "Sin carne",
    jevCheckTitle: "Comprobar un producto",
    jevCheckBody: "¿Tienes algo que no está en estas listas? Escríbelo y lo compruebo con tus dietas.",
    jevCheckPlaceholder: "p. ej. salsa Worcestershire",
    jevCheckBtn: "Comprobar",
    jevChecking: "Comprobando…",
    jevCautionApp: "{d}: {i} no cumple este ajuste.",
    jevCautionJev: "{d}: {i} suele llevar algo que este ajuste excluye. Mira la etiqueta.",
    jevNoClash: "No veo ningún choque con tus dietas. Las etiquetas cambian, así que mira el paquete si te importa.",
    jevNoCheck: "Ahora mismo no he podido pedir una segunda opinión. La etiqueta manda.",
    jevPriceHigh: "Eso es unas {r}× el precio habitual aquí ({m} por {g} g).",
    jevPriceLow: "Eso es unas {r}× menos que el precio habitual aquí ({m} por {g} g).",
    jevPriceOdd: "Parece raro para este producto aquí (suele ser unos {m} por {g} g).",
    jevPriceMean: "¿Querías decir {p}?",
    jevHintCurrency: "¿Lo escribiste en otra moneda?",
    jevHintPerKg: "¿Era el precio por kilo y no el del paquete?",
    jevHintItem: "¿Era otro producto — gourmet, preparado o un paquete grande?",
    jevPriceUse: "Usar {p}",
    jevPriceKeep: "Está bien — envíalo",
    jevPriceEdit: "Déjame corregirlo",
};
