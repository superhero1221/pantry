...
export const EXTRA: Record<string, Record<string, string>> = {
  en: {
    ...
    /* ── The opening carousel ── */
    slideH1: "Dinner, decided",
    slideS1: "Tell me what you fancy and what is in your pocket. I will do the deciding.",
    slideH2: "One thing at a time",
    slideS2: "No wall of choices. One dish, one reason it is there, and a way to change your mind.",
    slideH3: "Priced where you stand",
    slideS3: "Every dish carries a price range for the shops near you, in your money — not a London figure with the sign swapped.",
    slideH4: "Free. All of it",
    slideS4: "Every recipe, every price, six languages. No account needed, no card, nothing held back for later.",
    ...
    /* ── Jev second opinions (src/lib/jev.ts; only in a VITE_JEV=1 build) ── */
    jevReadAs: "Read as",
    jevUndo: "Undo",
    jevQuick: "Quick",
    jevCheap: "Cheap",
    jevComforting: "Comforting",
    jevLight: "Light",
    jevHighProtein: "High protein",
    jevSpicy: "Spicy",
    jevMeatFree: "Meat-free",
    jevCheckTitle: "Check an item",
    jevCheckBody: "Got something that is not on these lists? Type it and I will check it against your diets.",
    jevCheckPlaceholder: "e.g. Worcestershire sauce",
    jevCheckBtn: "Check",
    jevChecking: "Checking…",
    jevCautionApp: "{d}: {i} breaks this setting.",
    jevCautionJev: "{d}: {i} is often made with something this rules out. Check the label.",
    jevNoClash: "No clash spotted with your diets. Labels vary, so check the packet if it matters.",
    jevNoCheck: "Could not get a second opinion just now. The label is the answer.",
    jevPriceHigh: "That is about {r}× the usual price here ({m} for {g} g).",
    jevPriceLow: "That is about {r}× below the usual price here ({m} for {g} g).",
    jevPriceOdd: "That looks unusual for this item here (usually about {m} for {g} g).",
    jevPriceMean: "Did you mean {p}?",
    jevHintCurrency: "Was it typed in another currency?",
    jevHintPerKg: "Was that the price per kilo rather than for the pack?",
    jevHintItem: "Was it a different product — premium, prepared or a bulk pack?",
    jevPriceUse: "Use {p}",
    jevPriceKeep: "It is right — send it",
    jevPriceEdit: "Let me fix it",
  },
