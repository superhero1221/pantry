...
const PACKS = {
 "en": {
  ...
  "h": {"daysWord":"days","forServings":"one:for {n} serving|other:for {n} servings","otherChip":"Other","findMe":"Find me {q}","inKitchen":"{n} things already in your kitchen","passportNudge":"84 countries you have never cooked from. The cheapest one you are missing is Ethiopia — misir wot lands at {a} a serving.","liveShops":"one:{n} shop within walking distance, straight off OpenStreetMap|other:{n} shops within walking distance, straight off OpenStreetMap","week":["M","T","W","T","F","S","S"]},
  "v": {
  ...
  "x": {
   ...
   "onLast": "on last week",
   "nowW": "now","insteadOf":"Instead of buying it","youKeep":"You keep","everyTime":"every time you cook this instead of ordering it.","fourTimes":"Four times a month is","anOrderOf":"order of these is","forEight":"for eight. You get twelve for","andYouKeep":"and you keep","aPortion":"a portion.","microShow":"Iron, B12, fibre, salt …","microHide":"Hide the small print","twoOthers":"Two others that fit","browseSub":"Every dish costed for {city}, per serving, from the cheapest shop near you to the dearest. Nothing here is filtered by your budget — this is the lot.","statsSub":"one:{n} cook logged. All of it worked out on this phone — nothing here has been sent anywhere, and you can delete any of it.|other:{n} cooks logged. All of it worked out on this phone — nothing here has been sent anywhere, and you can delete any of it.","kitchenSub":"Everything here comes off your next shopping list automatically. You will not be asked to buy cumin again.","passportSub":"Every country you have cooked from, cheapest per serving first.","nudges":"Nudges","leftoverN":"Leftover nudges","leftoverS":"A reminder the day after, only when it keeps","shrinkN":"Portion learning","shrinkS":"Ask before shrinking a recipe you keep wasting","shopN":"Shop closing alerts","shopS":"Tell me when the cheapest shop is about to shut","carbs":"carbs","fat":"fat"},
  "s": {"shopSub":"shops within walking distance of","sameBasket":"Same basket, {n} prices.","openTill":"open till","hoursUnknown":"hours unknown"},
